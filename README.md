<p align="center">
  <a href="" rel="noopener">
  <img width=200px height=200px src="https://imgur.com/M3DZpAL.png" alt="Project logo"></a>
</p>


<h3 align="center">LOPA Backend</h3>

<div align="center">

[![Status](https://img.shields.io/badge/status-active-success.svg)]()
![GitHub issues](https://img.shields.io/github/issues/the-software-village-inc/lopa)
![GitHub pull requests](https://img.shields.io/github/issues-pr/the-software-village-inc/lopa?color=light%20green)
...
lopa is the backend of <b>LOPA</b>, a Risk Assessment and Hazard Evaluation Simulator.


## 💻 Tech <a name = "tech"></a>
lopa is written in [Python 3](https://www.python.org/) and [Django 3.2.9](https://www.djangoproject.com/).
...
- Run migrations command to create the tables in heroku after deployment.
  ...
  ```
Contact [Seunfunmi](https://github.com/seun-beta) for more details.
